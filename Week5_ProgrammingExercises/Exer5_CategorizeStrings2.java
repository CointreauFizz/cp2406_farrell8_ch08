...
public class Exer5_CategorizeStrings2 {
    ...
    public static void main (String[] args)
    {
        ...
        while(!entry.equals(QUIT))
        {
            ...
            if (letter.equals("o")) {
                ...
                if(letter.equals("t")) display(twoWords, twoWordsSub, "two-word");
                else {
                    if(letter.equals("l"))
    ...
    private static void display(String[] array, int max, String msg)
    {
        System.out.println("\nList of " + msg + " strings:");
        if(max == 0)
